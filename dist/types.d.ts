...
type CSSColorFunction = `rgb(${number}, ${number}, ${number})` | `rgba(${number}, ${number}, ${number}, ${number})` | `hsl(${number}deg ${number}% ${number}%)` | `hsl(${number}deg ${number}% ${number}%/ ${number}%)` | `hsla(${number}, ${number}%, ${number}%, ${number})` | `#${string}`;
